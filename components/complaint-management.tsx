  ...
  return (
    <div className="flex-1 flex flex-col overflow-hidden bg-white">
      <div className="flex items-center justify-between px-6 py-4 border-b">
        <h1 className="text-lg font-semibold text-gray-900">Summary View</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-3 mb-6">
          ...
          <div className="bg-white border border-gray-300 rounded p-3 shadow-sm">
            <div className="flex items-baseline justify-between">
              <div className="text-2xl font-bold text-gray-900">{openComplaints}</div>
          ...
          <div className="bg-white border border-gray-300 rounded p-3 shadow-sm">
            <div className="flex items-baseline justify-between">
              <div className="text-2xl font-bold text-gray-900">{inProgressComplaints}</div>
          ...
          <div className="bg-white border border-gray-300 rounded p-3 shadow-sm">
            <div className="flex items-baseline justify-between">
              <div className="text-2xl font-bold text-gray-900">{resolvedComplaints}</div>
