...
export function Dashboard() {
  ...
  return (
    <section className="bg-white rounded-lg shadow-md border border-gray-200 h-full">
      <div className="px-3 lg:px-4 py-2 lg:py-3 border-b border-gray-300 bg-white">
        <h2 className="text-base lg:text-lg font-bold text-gray-900">Dashboard</h2>
      </div>
      <CardContent className="p-2 sm:p-3 lg:p-4 space-y-3 lg:space-y-4 bg-gray-50">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-2 sm:gap-3 lg:gap-4">
          ...
          <div className="border-2 border-gray-300 rounded-lg overflow-hidden shadow-lg bg-white">
            <div className="bg-gray-900 text-white px-2 py-1.5 flex justify-between text-[10px] font-medium">
            ...
            <div className="divide-y divide-gray-200 text-[10px]">
              <div className="flex justify-between px-2 py-1.5 hover:bg-gray-50">
                <span className="text-gray-700">Admin</span>
                <div className="flex gap-4 w-20 justify-end text-gray-900">
                  <span>2</span>
                  <span>00.00</span>
                </div>
              </div>
              <div className="flex justify-between px-2 py-1.5 bg-gray-50 hover:bg-gray-100">
              ...
              <div className="flex justify-between px-2 py-1.5 font-semibold bg-gray-100 border-t-2 border-gray-300">
          ...
          <div className="border-2 border-gray-300 rounded-lg p-2 lg:p-3 shadow-lg bg-white">
            <div className="text-[10px] text-center mb-2 font-semibold text-gray-900">Staff Nationality Distribution</div>
            <div className="flex justify-center items-center h-[160px] lg:h-[180px]">
              <img
            ...
            <div className="flex flex-wrap gap-x-2 gap-y-1 justify-center text-[9px] mt-2">
              <div className="flex items-center gap-1">
                <div className="h-2 w-2 rounded-full shadow-sm bg-[#10b981]" />
                <span className="text-gray-700">Bahrain</span>
              </div>
              <div className="flex items-center gap-1">
                <div className="h-2 w-2 rounded-full shadow-sm bg-[#f59e0b]" />
                <span className="text-gray-700">Pakistan</span>
              </div>
              <div className="flex items-center gap-1">
                <div className="h-2 w-2 rounded-full shadow-sm bg-[#3b82f6]" />
                <span className="text-gray-700">Saudi Arabia</span>
              </div>
              <div className="flex items-center gap-1">
                <div className="h-2 w-2 rounded-full shadow-sm bg-[#ef4444]" />
                <span className="text-gray-700">United States</span>
              </div>
              <div className="flex items-center gap-1">
                <div className="h-2 w-2 rounded-full shadow-sm bg-[#8b5cf6]" />
        ...
        {/* Leave Type Table */}
        <div className="border-2 border-gray-300 rounded-lg overflow-hidden shadow-lg bg-white">
          <div className="bg-gray-100 px-2 py-1.5 grid grid-cols-4 text-[10px] font-semibold border-b border-gray-200 text-gray-900">
          ...
          <div className="divide-y divide-gray-200 text-[10px]">
            {leaveTypeData.map((item, idx) => (
              <div key={idx} className="grid grid-cols-4 px-2 py-1.5 hover:bg-gray-50">
            ...
            <div className="grid grid-cols-4 px-2 py-1.5 font-semibold bg-gray-100 border-t-2 border-gray-300">
              <span className="text-gray-900">Total</span>
        ...
        {/* Bar Chart Section */}
        <div className="border-2 border-gray-300 rounded-lg p-2 lg:p-3 shadow-lg bg-white">
          <div className="text-[10px] text-gray-600 mb-2 font-medium">Type of Leaves and Number of Days</div>
